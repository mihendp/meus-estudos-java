...
*/
public class RefatorandoOrdenacaoMap {
    ...
    public static void main(String[] args) {
        ...
        /*Set<Map.Entry<Integer, Contato>> set1 = new TreeSet<>(new Comparator<Map.Entry<Integer, Contato>>() {
            @Override
            public int compare(Map.Entry<Integer, Contato> cont1, Map.Entry<Integer, Contato> cont2) {
                int nome = cont1.getValue().getNome().compareToIgnoreCase(cont2.getValue().getNome());
                if (nome != 0){
                    return nome;
                }
                return Integer.compare(cont1.getValue().getNumero(), cont2.getValue().getNumero());
        ...
        /*Set<Map.Entry<Integer, Contato>> set1 = new TreeSet<>(Comparator.comparing(new Function<Map.Entry<Integer,Contato>, String>() {
            @Override
            public String apply(Map.Entry<Integer, Contato> cont1) {
                return cont1.getValue().getNome();
            }
        }));*/
